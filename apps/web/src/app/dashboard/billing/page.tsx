...
function BillingPageContent() {
  ...
  const fetchBillingStatus = useCallback(async () => {
    try {
      ...
      setBillingStatus({
        tier: data.tier as 'FREE' | 'PRO' | 'TEAM',
  ...
  const handleCheckout = async (tier: 'PRO' | 'TEAM') => {
    ...
    try {
      ...
      const checkoutData = await authApi.createCheckout(tier, isAnnual ? 'annual' : 'monthly');
            ...
            <Card className="bg-card/50 border-border/50">
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Click the &quot;Cancel&quot; button above to cancel your subscription.
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    ...
                    charged the prorated difference. When downgrading, you&apos;ll receive credit
